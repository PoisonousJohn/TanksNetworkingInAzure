...
public class GameManager : NetworkBehaviour
{
    ...
    /// <param name="connectionID">The server connection ID</param>
    static public void AddTank(GameObject tank, int playerNum, Color c, string name, int localID, int connectionID)
    {
        ...
        tmp.m_ConnectionID = connectionID;
        tmp.Setup();
    ...
    private IEnumerator RoundEnding()
    {
        ...
        if (m_GameWinner == null && m_Tanks.Count == 1)
        {
